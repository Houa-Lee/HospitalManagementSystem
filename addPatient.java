...
public class addPatient extends JFrame {
	...
	public addPatient() {
		...
		JLabel addNewPatient = new JLabel("Add a new Patient");
		addNewPatient.setFont(new Font("Tahoma", Font.BOLD, 14));
		addNewPatient.setBounds(32, 11, 243, 23);
		contentPane.add(addNewPatient);
			...
			public void actionPerformed(ActionEvent e) {
				if(isNumeric(idField.getText()))
				{
					sq.add(contentPane, Integer.parseInt(idField.getText()), fnameField.getText(), 
							lnameField.getText(), usertype.getText(), pw.getText(), addressField.getText());
					clear();
				} else {
		...
		addressField.setBounds(92, 184, 420, 20);
		contentPane.add(addressField);
		addressField.setColumns(10);
		
		JLabel lblNewLabel_1 = new JLabel("Address");
		lblNewLabel_1.setBounds(32, 190, 56, 14);
